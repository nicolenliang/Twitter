...
public class TwitterClient extends OAuthBaseClient
{
	...
	public void getHomeTimeline(JsonHttpResponseHandler handler)
	{
		...
		params.put("count", 25); // returns 25 tweet objects
		params.put("since_id", 1); // since_id filters tweets since id of certain tweet; having it at 1 = no filter
		client.get(apiUrl, params, handler);
	}

	public void getInfiniteTimeline(long maxID, JsonHttpResponseHandler handler)
	{
		String apiUrl = getApiUrl("statuses/home_timeline.json");
		RequestParams params = new RequestParams();
		params.put("count", 25);
